...
- 推荐顺序：A4.1→A4.2→A4.3 → C3.1→C3.2→C3.3 → B4.1→B4.2→B4.3 → X4.1→X4.2 → M4.1
- 共 **12** 个单元
...
| 10 | G-X4.1 | [G-X4.1-degradation-testing.md](units/G-X4.1-degradation-testing.md) | 全部功能单元 |
| 11 | G-X4.2 | [G-X4.2-security-baseline.md](units/G-X4.2-security-baseline.md) | G-X4.1 |
